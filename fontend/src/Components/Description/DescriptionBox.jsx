...
<div className="descriptionbox-nav-box fade">Reviews (122)</div>
    ...
    <div className="descriptionbox-description">
      ...
      <p>E-commerce websites typically display products or services along with details descriptions, images, prices and any available variations (e.g. sizes, colours). Each product usually has its own dedicated page with relevant information. </p>
    </div>
    </div>)
}
